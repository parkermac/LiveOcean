...
This is a fairly complicated tesk because it involves coordinating
...
and then it runs for all three years.

Result: typically the errors are acceptably small, like 1%
depending on how you defin "error".
...
for year in [2017, 2018, 2019]:
    ...
    salt_df[['dSnet_dt','QSin','-QSout']].plot(ax=ax, grid=True).legend(loc='upper right')
