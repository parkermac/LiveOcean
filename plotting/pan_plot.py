...
# standard arguments
parser.add_argument('-g', '--gridname', nargs='?', type=str, default='sj0')
parser.add_argument('-t', '--tag', nargs='?', type=str, default='v0')
parser.add_argument('-x', '--ex_name', nargs='?', type=str, default='lo8nest')
parser.add_argument('-0', '--date_string0', nargs='?', type=str, default='2019.07.23')
