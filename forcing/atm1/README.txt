...
============================================================================
* plot_grids.py makes a nice plot of the domain and grid spacing of the ROMS grid and all three of the WRF grids used.