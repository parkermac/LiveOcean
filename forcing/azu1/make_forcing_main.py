...
It creates and exports a single NetCDF file containing only the surface fields
from all the history files in a given day.

The resulting file for cascadia1 with bio and carbon is 327 MB, compared to
214 MB for EACH of the history files.  This means we are pushing 47x less
to azure.
