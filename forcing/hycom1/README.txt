...
Then the newer GOFS 3.1 and goes back as Renanalysis to 1994, and as Analysis to the present.  What we use in forcing/ocn3 is "GLBy0.08 grid is 0.08 deg lon x 0.04 deg lat that covers 80S to 90N." so this is a different grid than GLBu, having twice the latitude resolution.
