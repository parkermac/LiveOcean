...
% out_dir: directory for output to go - for example, out_dir='/home/disk/edward/siedlesa/turbo40forcingfiles/2007/';
...
if ~exist(clmname,'file')
    disp(['WARNING: Climatology file does not exist. Create a clm file with make_clim.m before adding bio variables.']);
end
...
%     %%Create NO3 field
   ...
   PIC = zeros(size(ini_salt)); % Initializing with no PIC
    ...
    %put the fileds into the ini file
    %Store the data
