%function run_co2sys_his(indir, moor_file, in3)

% USE CO2SYS.m to add pH and Aragonite Saturations State to a
% ROMS history file.

% testing
indir = '/Users/PM5/Documents/LiveOcean_roms/output/cascadia1_base_lobio1/f2015.09.19/';
fn = 'ocean_his_0002.nc';

addpath('../../shared/seawater');

ncid = netcdf.open([indir,fn], 'WRITE');
...
% var2get_list = {'TIC','alkalinity','salt','temp','zeta'};
