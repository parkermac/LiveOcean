...
# less information buried in the makefile programs.
...
#
# example calls:
# ./driver_roms.sh -g cas4 -t v2 -x lo6biom -np 196 -N 28 -s continuation -r forecast
# ./driver_roms.sh -g cas5 -t v3 -x lo8 -np 64 -N 32 -s new -r backfill -0 20170101 -1 20170101
# ./driver_roms.sh -g cas5 -t v3 -x lo8 -np 64 -N 32 -s continuation -r backfill -0 20170102 -1 20170131
